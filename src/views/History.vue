<template>
    <v-container fluid class="text-center">
        <v-card>
            ...
            <v-row>
                <v-col class="ma-4">
                    <h1 class="display-2 mb-3">A Little History...</h1>
                    <br />
                    <p
                        class="text-left"
